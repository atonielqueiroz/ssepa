...
CREATE TABLE "ReminderNote" (
    ...
    "text" TEXT NOT NULL,
    CONSTRAINT "ReminderNote_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_Reference" ("assuntoPrincipal", "autuacaoAt", "city", "classeProcessual", "competencia", "court", "createdAt", "diasTramitacao", "distribuicaoAt", "execNumber", "executadoNascimento", "executadoNascimentoSourceText", "executadoNome", "id", "juiz", "juizo", "nivelSigilo", "notes", "novoCrimeDoloso", "progEspecial112_3_enabled", "progEspecial112_3_req_III_cumpriuUmOitavoRegAnterior", "progEspecial112_3_req_II_naoCrimeContraFilho", "progEspecial112_3_req_IV_primariaBomComport", "progEspecial112_3_req_I_semViolencia", "progEspecial112_3_req_V_naoOrgCrim", "reeducandaGestante", "reeducandaMaeOuResponsavelCriancaOuPcd", "reeducandoGender", "semExecucaoFormada", "source", "stateUf", "status", "title", "updatedAt", "userId") SELECT "assuntoPrincipal", "autuacaoAt", "city", "classeProcessual", "competencia", "court", "createdAt", "diasTramitacao", "distribuicaoAt", "execNumber", "executadoNascimento", "executadoNascimentoSourceText", "executadoNome", "id", "juiz", "juizo", "nivelSigilo", "notes", "novoCrimeDoloso", "progEspecial112_3_enabled", "progEspecial112_3_req_III_cumpriuUmOitavoRegAnterior", "progEspecial112_3_req_II_naoCrimeContraFilho", "progEspecial112_3_req_IV_primariaBomComport", "progEspecial112_3_req_I_semViolencia", "progEspecial112_3_req_V_naoOrgCrim", "reeducandaGestante", "reeducandaMaeOuResponsavelCriancaOuPcd", "reeducandoGender", "semExecucaoFormada", "source", "stateUf", "status", "title", "updatedAt", "userId" FROM "Reference";
...
-- CreateIndex
CREATE INDEX "ReminderNote_userId_idx" ON "ReminderNote"("userId");

-- CreateIndex
CREATE INDEX "ReminderNote_entityType_entityId_idx" ON "ReminderNote"("entityType", "entityId");

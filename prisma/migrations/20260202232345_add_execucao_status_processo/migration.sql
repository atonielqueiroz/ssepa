...
INSERT INTO "new_ProcessoCriminal" ("acordaoAt", "createdAt", "denunciaRecebidaAt", "id", "juizoVaraCondenacao", "marcosSource", "notes", "number", "reAt", "referenceId", "respAt", "sentencaAt", "source", "transitAtAcusacao", "transitAtDefesa", "transitAtProcesso", "updatedAt") SELECT "acordaoAt", "createdAt", "denunciaRecebidaAt", "id", "juizoVaraCondenacao", "marcosSource", "notes", "number", "reAt", "referenceId", "respAt", "sentencaAt", "source", "transitAtAcusacao", "transitAtDefesa", "transitAtProcesso", "updatedAt" FROM "ProcessoCriminal";

...
CREATE TABLE "new_ProcessoCriminal" (
    ...
    "reincidenciaMode" TEXT NOT NULL DEFAULT 'AUTO',
    "reincidenciaStatus" TEXT,
    "acordaoAt" DATETIME,
    "respAt" DATETIME,
    "reAt" DATETIME,
